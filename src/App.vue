  ...
  methods: {
    ...
    setInterceptor: function(resourcePermission) {
      ...
      myInterceptor = instance.interceptors.request.use(function(config) {
        ...
        console.log(perName,'/////////////////////////////////////')
        //校验权限
        console.log(resourcePermission[config.method + ',' + perName],'666666666666666666666666666')
    ...
    getRoutes: function(userInfo) {
      ...
      console.log(arrayMenus,'mmmmmmmmmmmmmmmmmmm')
      //将多维数组转成对象格式
      let hashMenus = {};
      ...
      console.log(hashMenus,'hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh')
   ...
   /**
    *    1获取用户的token  检查token 是否存在  如果不存在 跳转到登录页面
    *    
    *    2.设置请求头同意携带 token   获取用户的权限信息
    * 
    *    3.
    *  
    * 
